...
{
	public class EfArticleRepository : EfEntityRepositoryBase<Article, ProjectDbContext>, IArticleRepository
	{
		public EfArticleRepository(ProjectDbContext context) : base(context)
		{
		}
	}
}
