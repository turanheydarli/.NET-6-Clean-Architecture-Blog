...
{
	public class EfArticleRepository : EfEntityRepositoryBase<Article, MsDbContext>, IArticleRepository
	{
		public EfArticleRepository(MsDbContext context) : base(context)
		{
		}
	}
}
