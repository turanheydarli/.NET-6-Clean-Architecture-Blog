...
{
	public class EfSettingRepository : EfEntityRepositoryBase<Setting, ProjectDbContext>, ISettingRepositoy
	{
		public EfSettingRepository(ProjectDbContext context) : base(context)
		{
		}
	}
}
